...
<div class="cboth-padd" style="
  ...
  <div class="price-section app-sec" style="background: none;">
    ...
    margin-left: 448px;    padding-top: 37px;">
      <h1 style="text-align: center;color: orange;"> <?php
       if(isset($_SESSION["tcod"]))
       {
           ...
           echo $obj->trptit;
            ...
            ?></h1>
       <form class="form-signin" name="frmuplpic" method="Post" action="frmuplpic.php" enctype="multipart/form-data" onsubmit="return abc()">
            <table width="100%">
                <tr>
                <td>Browse Picture</td>
                <td>
                    <input type="file" name="filupl" style="margin-bottom: 12px;" class="form-control"/>
                </td>
                </tr>
                <tr>
                    <td>Description</td>
                    <td>
                        <textarea name="txtdsc" id="txtdesc" rows="4" cols="50" style="margin-bottom: 12px;" class="form-control"></textarea>                    
</td>
                </tr>
                <tr>
                    <td></td>
 ...
 <?php
   if(isset($_SESSION["tcod"]))         
   {
       ...
       for($i=0;$i<count($arr1);$i++)
       {
           ...
           echo "<a class=upload href=frmuplpic.php?pcod=".$arr1[$i][0]." >Delete</a><br>";
