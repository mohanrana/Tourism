...
if (isset($_SESSION["cod"])) {
    ...
    echo "<li class='active'><a href='frmreg.php'>Register</a></li>";
                    ...
                    <div class="cboth-padd" >
                        ...
                        <div class="price-section app-sec" style="background: none;">
                            ...
                            <div class="Contact" style="    width: 456px;
                                ...
                                <form class="form-signin" name="frmreg" method="Post" action="frmreg.php" onsubmit="return checkForm(this);">

                                    <div class="input-form">
                                        <!--  <label class="" for="inputEmail">Email address</label>-->
                                        <input type="text" id="inputnam" style="margin-bottom: 12px;" name="txtnam" class="form-control" placeholder="Name" required="" autofocus=""></div>

                                    <div class="input-form">
                                        <!--  <label class="" for="inputEmail">Email address</label>-->
                                        <input type="email" id="inputEmail" style="margin-bottom: 12px;" name="txteml" class="form-control" placeholder="Email" required="" autofocus=""></div>
                                    <div class="input-form">
                                        <!--  <label class="" for="inputEmail">Email address</label>-->
                                    ...
                                    <div class="input-form">
                                        ...
                                        <p><img src="random.php" width="120" height="30" border="1" alt="CAPTCHA"></p>
                                        <p><input type="text" size="6" maxlength="5" name="captcha" style="margin-bottom: 12px;" class="form-control" value=""><br>
                                            <small>copy the digits from the image into this box</small></p>

                                    </div>
                                    <input class="btn btn-lg btn-block" type="submit"
                                           name="btnsub" value="Submit"  onclick="return abc()"/>
