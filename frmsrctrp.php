                        ...
                        <div class="nav-header">
                            ...
                            <nav id="fh5co-menu-wrap" role="navigation">
                                <ul class="sf-menu" id="fh5co-primary-menu">
                                    ...
                                    <li class="active"><a href="frmsrctrp.php">Search Trip</a></li>
                    ...
                    <div class="price-section app-sec" style="background: none;">
                        <div class="Contact" style="    width: 456px;
                            ...
                            <form name="frmsrctrp" method="Post" action="frmsrctrp.php">
                                <h2 style="text-align: center;color: orange;">Search Trips</h2>
                                <table width="100%" class="searchform">
                                    <tr>
                                        <td>Select City</td>
                                        <td>
                                            <select name="drpcty" style="margin-bottom: 12px;"  class="form-control" onchange="abc(this.value);">
<?php
$obj = new clscty();
$arr = $obj->disp_rec();
...
?>
                                                ...
                                                if (isset($_SESSION["lcod"])) {
                                                    ...
                                                    for ($i = 0; $i < count($arr); $i++) {
                                                        ...
                                                        echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                                        echo "<a href=frmsrctrp.php?tcod=" . $arr[$i][0] . "><img src=images/like.png height=40px width=60px /></a>";
                                                        echo "</td>";
                                                        // if($j==1)
                                                        // {
                                                        echo "</tr>";
