...
if (isset($_POST["btnsub"])) {
    ...
    $BusSeatCount=$_POST["BusSeatCount"];
    $AvlSts=$_POST["AvlSts"];
    $bustime=$_POST["bustime"];
   
   $qry="insert tbbus values(null,'$BusNumber','$BusRoot',$BusSeatCount,'$AvlSts','$bustime')";
    $res=  mysqli_query($link, $qry);
  
 }
if (isset($_REQUEST["bcod"])) {
     $qry="delete from tbbus where busID=".$_REQUEST["bcod"];
    $res=  mysqli_query($link, $qry);
}
?>
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
                                                    ...
                                                    <li class="active"><a href="frmAddbus.php">Add Bus</a></li>
    ...
    <script src="../js/sebastian-carousel.js" type="text/javascript"></script>
        ...
        <section class="services">
            <div class="container">
                <hr class="hr">
                <form name="frmcty"  method="Post" action="frmAddbus.php" >
                    <div class="dd1">  Add New Bus</div>
                    ...
                    <table width="50%" class="t1">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="BusRoot" required="" />                         
                            </td>
                         ...
                         <tr>
                            ...
                            <td>
                                <input type="text" name="BusSeatCount" required="" />                         
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="00:AM/PM" name="bustime"/>                     
                            </td>
...
<?php
        $qry="select * from tbbus";
        $res=  mysqli_query($link, $qry);
        
            echo "<table width=50% class=t1><tr><th>Number</th><th>Root</th><th>Seat Count</th><th>Status</th><th>Time</th></tr>";
 ...
 echo "<td>".$r[4]."</td>";
 echo "<td>".$r[5]."</td>";
 echo "<td><a class=upload href=frmhotel.php?bcod=".$r[0]." >Delete</a></td>";
 echo "</tr>";
        }
        echo "</table>";
?>
