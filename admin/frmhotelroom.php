...
if (isset($_POST["btnsub"])) {
    $hID=$_POST["selectHotel"];
    $roomdec=$_POST["roomdsc"];
    $roomcnt=$_POST["roomcnt"];
    $file=$_FILES["file"]["name"];
   $qry="insert tbbookroom values(null,'$roomdec',$roomcnt,'$file',$hID)";
    $res=  mysqli_query($link, $qry) or die(mysqli_errno($link));
  //  $id=  mysqli_insert_id($res);
    move_uploaded_file($_FILES["file"]["tmp_name"],
         "../roompic/".$_FILES["file"]["name"]);
 }
if (isset($_REQUEST["rcod"])) {
     $qry="delete from tbbookroom where roomID=".$_REQUEST["rcod"];
    $res=  mysqli_query($link, $qry);
}
if(isset($_REQUEST["hcod"]))
{
    $_SESSION["hcod"]=$_REQUEST["hcod"];
}
?>
...
<html>
    ...
    <script>
   function fatchroom(a)
   {
       window.location="frmhotelroom.php?hcod="+a;
   }
    </script>
	</head>
	<body>
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
                                                    ...
                                                    <li class="active"><a href="frmhotelroom.php">Add Rooms</a></li>
    ...
    <script src="../js/sebastian-carousel.js" type="text/javascript"></script>
        ...
        <section class="services">
            <div class="container">
                <hr class="hr">
                <form name="frmcty"  method="Post" action="frmhotelroom.php" enctype="multipart/form-data">
                    <div class="dd1">  Add New Rooms</div>
                    ...
                    <table width="50%" class="t1">
                        <tr>
                            ...
                            <td>
                                <select name="selectHotel" onchange="fatchroom(this.value)">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="roomdsc" rows="5" cols="25"></textarea>                              
                            </td>
...
<?php
if(isset($_SESSION["hcod"]))
{
        $qry="select * from tbbookroom where roomHotelID=".$_SESSION["hcod"];
        $res=  mysqli_query($link, $qry);
        
            echo "<table width=50% class=t1><tr><th></th><th>Description</th><th>Room Count</th></tr>";
        while ($r=  mysqli_fetch_row($res))
                {
            echo "<tr><td><img src=../roompic/".$r[3]." style=height:142px;width:189px /></td>";
 echo "<td>".$r[1]."</td>";
 echo "<td>".$r[2]."</td>";
 echo "<td><a class=upload href=frmhotelroom.php?rcod=".$r[0]." >Delete</a><br>";
 echo "</tr>";
        }
        echo "</table>";
}
